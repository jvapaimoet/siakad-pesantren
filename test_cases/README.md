...
| ----- | -------------------- | ------------------------------------ | ---------------------- | ---------------------------------- |
| TC001 | Login Ustadz/Santri  | Masukkan email, password, dan tipe akun benar | Akun sesuai role       | Sistem berhasil masuk dashboard    |
...
| ID    | Fitur            | Langkah Pengujian          | Input          | Hasil Yang Diharapkan          |
| ----- | ---------------- | -------------------------- | -------------- | ------------------------------ |
| TC009 | Login Ustadz/Santri | Password dikosongkan atau tipe akun salah | Email saja / role salah | Sistem menampilkan pesan error |
