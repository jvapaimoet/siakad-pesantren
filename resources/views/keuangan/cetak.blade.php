...
<body class="bg-gray-100 font-sans text-gray-900">
    <main class="max-w-5xl mx-auto bg-white min-h-screen p-8">
        <div class="no-print mb-6 flex justify-between items-center">
            <a href="{{ route('keuangan.index') }}" class="text-sm font-semibold text-emerald-700 hover:text-emerald-900">
                Kembali ke Keuangan
            </a>
        ...
        <table class="w-full border border-gray-300 text-sm">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="6" class="border border-gray-300 px-3 py-8 text-center text-gray-500">Belum ada data.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
