<x-guest-layout>
    <div class="text-center mb-6">
        <div class="flex items-center justify-center mb-4">
            <i class="fas fa-chalkboard-user text-5xl text-blue-700"></i>
        </div>
        <h2 class="text-2xl font-bold">Login Ustadz</h2>
        <p class="text-gray-600 text-sm">Masuk sebagai pengajar</p>
    </div>

    <form method="POST" action="{{ route('login') }}">
        @csrf
        <input type="hidden" name="role" value="ustadz">
        ...
        <button type="submit"
            class="w-full mt-6 bg-blue-700 hover:bg-blue-800 text-white py-2 rounded-lg font-semibold transition">
            Masuk
        </button>
